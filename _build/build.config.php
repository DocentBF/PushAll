...
define('PKG_STORE_API_KEY', ''); // ключ из modstore.pro
define('PKG_STORE_USERNAME', ''); // email аккаунта на modstore.pro
...
define('BUILD_COMPOSER_DEPENDECIES', false);
