...
if (file_exists('build.prepare.php') && BUILD_COMPOSER_DEPENDECIES) {
...
if(!empty(PKG_STORE_API_KEY) && !empty(PKG_STORE_USERNAME) && PKG_ENCRYPT) {

    require_once XPDO_CORE_PATH . 'xpdo.class.php';
    require_once XPDO_CORE_PATH . 'transport/xpdotransport.class.php';
    require_once XPDO_CORE_PATH . 'transport/xpdovehicle.class.php';
    require_once XPDO_CORE_PATH . 'transport/xpdofilevehicle.class.php';
    require_once XPDO_CORE_PATH . 'transport/xpdoscriptvehicle.class.php';
    require_once XPDO_CORE_PATH . 'transport/xpdoobjectvehicle.class.php';

    require_once $sources['build'] . '/includes/encrypt/encpackagebuilder.class.php';
    require_once $sources['build'] . '/includes/encrypt/encryptedvehicle.class.php';
    require_once $sources['build'] . '/includes/keyrequester.class.php';

    $keyRequester = new KeyRequester($modx, array(
        KeyRequester::PARAM_API_KEY => PKG_STORE_API_KEY, // ключ из modstore.pro
        KeyRequester::PARAM_USERNAME => PKG_STORE_USERNAME, // email аккаунта на modstore.pro
    ...
    $builder = new encPackageBuilder($modx);
} else {
