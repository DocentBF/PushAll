...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('pushall_core_path', null,
                    $modx->getOption('core_path') . 'components/pushall/') . 'model/';
            $modx->addPackage('pushall', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/pushall/model/schema/pushall.mysql.schema.xml';
